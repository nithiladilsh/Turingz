      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <PersonCard i={1} icon={Link2} tone="bg-violet-600" name="Dharmapala R.D." id="214050V" module="Module 2 &middot; Coupling"
            ...
            limitations="The switch-time and restart-fidelity studies were run on a modest number of held-out waves at a single spatial resolution, so the exact point where a hand-off stops being worth it should be read as a property of this benchmark, not yet shown to hold on other equations."
